...
function fetchIssues(){
  if (localStorage['probs']){
    ...
    issueList.innerHTML += `<li class="list-group-item ">
      ...
      <article class="py-2">
        ...
        <p></p>
        <button type="button" name="button" id="close-issue" class="btn btn-warning" onclick="setStatusClosed('${issueId}')">Close</button>
